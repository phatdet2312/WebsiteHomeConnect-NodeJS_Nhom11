...
const ctrl = require('../../controllers/admin/trangThaiController');

router.get('/', ctrl.renderList);
router.get('/add', ctrl.renderAddForm);
router.post('/add', uploadTrangThai, ctrl.processAdd);
router.get('/display/:id', ctrl.renderDisplay);
router.get('/update/:id', ctrl.renderUpdateForm);
router.post('/update/:id', uploadTrangThai, ctrl.processUpdate);
